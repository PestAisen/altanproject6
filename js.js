...
var player = { x: 160, y: 340, height: 80, width: 65, xSpeed:0, ySpeed:0 };
...
function draw(){
    ...
    pic = new Image();
    pic.src = "block.png";
    context.drawImage(pic, enemy.x, enemy.y, enemy.width, enemy.height)
    ...
    context.fillStyle = "black";
    context.fillText("Проёдено: " + gameTime, 10, 30)
}
